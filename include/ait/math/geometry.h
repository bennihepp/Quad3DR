...
public:
  ...
  Triangle getCanonicalTriangle() const {
    ...
    AIT_ASSERT((can_tri.v2_ - can_tri.v1_).squaredNorm() >= (can_tri.v3_ - can_tri.v2_).squaredNorm());
    AIT_ASSERT((can_tri.v2_ - can_tri.v1_).squaredNorm() >= (can_tri.v1_ - can_tri.v3_).squaredNorm());
    return can_tri;
  }
