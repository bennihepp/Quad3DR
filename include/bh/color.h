...
public:
  ...
  Color4(const Base& color_vector)
  : Base(color_vector) {}

  template <typename Derived>
  Color4(const Derived& color_vector)
  : Base(color_vector) {}
...
public:
  ...
  Color3(const Base& color_vector)
  : Base(color_vector) {}

  template <typename Derived>
  Color3(const Derived& color_vector)
  : Base(color_vector) {}
...
public:
  ...
  Color4HSV(const Base& color_vector)
  : Base(color_vector) {}

  template <typename Derived>
  Color4HSV(const Derived& color_vector)
  : Base(color_vector) {}
...
public:
  ...
  Color3HSV(const Base& color_vector)
  : Base(color_vector) {}

  template <typename Derived>
  Color3HSV(const Derived& color_vector)
  : Base(color_vector) {}
...
public:
  ...
  Color3<FloatType> map(FloatType value) const override {
    FloatType r = bh::clamp(std::min(4 * value - (FloatType)1.5, -4 * value + (FloatType)4.5));
    FloatType g = bh::clamp(std::min(4 * value - (FloatType)0.5, -4 * value + (FloatType)3.5));
    FloatType b = bh::clamp(std::min(4 * value + (FloatType)0.5, -4 * value + (FloatType)2.5));
...
public:
  ...
  Color3<FloatType> map(FloatType value) const override {
    ...
    rgb.r() = bh::clamp(2 * value);
    rgb.g() =  bh::clamp(2 * std::max(value - (FloatType)0.5, (FloatType)0));
    rgb.b() = 0;
    return rgb;
  }
